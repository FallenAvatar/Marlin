...
#define TRAMMING_POINT_XY { {	50, 75 }, { X_MAX_POS - 50,	75 }, { X_MAX_POS - 50, Y_MAX_POS - 75 }, { 50, Y_MAX_POS - 75 } }
...
// @section lcd
	...
	#define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, Z1, E from panel
...
// FIXME: Causing issues, I know they are plugged in correctly
